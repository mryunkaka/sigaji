...
function ui_icon(string $name, string $class = 'h-5 w-5'): string
{
    $icons = [
        ...
        'cog-6-tooth' => '<path stroke-linecap="round" stroke-linejoin="round" d="M11.42 2.184a1.125 1.125 0 0 1 1.16 0l1.04.6a1.125 1.125 0 0 0 1.08.045l1.067-.49a1.125 1.125 0 0 1 1.494.52l.54 1.103a1.125 1.125 0 0 0 .837.62l1.213.176a1.125 1.125 0 0 1 .927 1.114v1.2a1.125 1.125 0 0 0 .405.862l.92.78a1.125 1.125 0 0 1 .244 1.44l-.6 1.04a1.125 1.125 0 0 0-.045 1.08l.49 1.067a1.125 1.125 0 0 1-.52 1.494l-1.103.54a1.125 1.125 0 0 0-.62.837l-.176 1.213a1.125 1.125 0 0 1-1.114.927h-1.2a1.125 1.125 0 0 0-.862.405l-.78.92a1.125 1.125 0 0 1-1.44.244l-1.04-.6a1.125 1.125 0 0 0-1.08.045l-1.067.49a1.125 1.125 0 0 1-1.494-.52l-.54-1.103a1.125 1.125 0 0 0-.837-.62l-1.213-.176A1.125 1.125 0 0 1 2.25 18.13v-1.2a1.125 1.125 0 0 0-.405-.862l-.92-.78a1.125 1.125 0 0 1-.244-1.44l.6-1.04a1.125 1.125 0 0 0 .045-1.08l-.49-1.067a1.125 1.125 0 0 1 .52-1.494l1.103-.54a1.125 1.125 0 0 0 .62-.837l.176-1.213a1.125 1.125 0 0 1 1.114-.927h1.2a1.125 1.125 0 0 0 .862-.405l.78-.92a1.125 1.125 0 0 1 1.44-.244l1.04.6a1.125 1.125 0 0 0 1.08-.045l1.067-.49Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />',
    ];
